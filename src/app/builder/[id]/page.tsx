                ...
                <div className="container" style={{ padding: '2rem 0', maxWidth: '800px' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                            <button onClick={addQuestion} className="btn btn-secondary" style={{ padding: '2rem', borderStyle: 'dashed', borderWidth: '2px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.5rem' }}>
                                <Plus size={24} />
                                Add Question Manually
                            </button>
                            <button onClick={() => setShowAIModal(true)} className="btn btn-secondary" style={{ padding: '2rem', borderStyle: 'dashed', borderWidth: '2px', borderColor: 'var(--primary)', background: 'rgba(99, 102, 241, 0.05)', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.5rem', color: 'var(--primary)' }}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                                    <span style={{ fontSize: '1.25rem' }}>✨</span>
                                    <span style={{ fontWeight: 600 }}>AI Generator</span>
                                </div>
                                <span style={{ fontSize: '0.875rem', opacity: 0.8 }}>Create questions instantly</span>
                            </button>
                        </div>
                    </div>
